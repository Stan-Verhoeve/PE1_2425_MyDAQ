...
class MyDAQ:
    ...
    def _addOutputChannels(self, task: dx.task.Task, channels) -> None:
        """
    ...
    def _addInputChannels(self, task: dx.task.Task, channels) -> None:
        """
    ...
    def read(self, duration: float, *channels, timeout: float = 300) -> None:
        """
    ...
    def write(self, voltages: np.ndarray, *channels) -> None:
        """
    ...
    def readwrite(self, voltages: np.ndarray, readChannels, writeChannels, timeout: float = 300):
        samples = max(voltages.shape)
